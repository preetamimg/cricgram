    ...
    <>
        ...
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
                ...
                <tr>
                  ...
                  <tr>
                    <td colSpan={7} className='extraTd'>
                      <span>YET TO BAT:</span> Aditya Thakare, Aditya Sarwate, Yash Thakur, Umesh Yadav
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={7} className='extraTd'>
            ...
            <div className="fallOfWickets my-2">
              ...
              <div className="value"><span>8-1</span> (<span className="activeSpan">Peculiar Agboya</span>, 1.1), <span>8-2</span> (<span className="activeSpan">Peculiar Agboya</span>, 1.4), <span>8-3</span> (Favour Eseigbe, 2.6)</div>
            </div>
      ...
      <div className="fallOfWickets fallOfWic py-0">  {/* add loading class here */}
            ...
            <div className="row keyValueDiv">
              ...
              <div className="col-8 key value"> <span>10 Mar 2024, Sun, 9:30 AM IST</span></div>
            </div>
            <div className="row keyValueDiv">
              <div className="col-4 value">TOSS</div>
              <div className="col-8 key value"> <span>Vidarbha elected to bowl</span></div>
            </div>
            <div className="row keyValueDiv">
              <div className="col-4 value">VENUE</div>
              <div className="col-8 key value"> <span>Wankhede Stadium, Mumbai</span></div>
            </div>
            <div className="row keyValueDiv">
              <div className="col-4 value">UMPIRES</div>
              <div className="col-8 key value"> <span>Khalidhussen A Saiyed (India), K N Ananthapadmanabhan (India), Virender Sharma(India, TV)</span></div>
            </div>
            <div className="row keyValueDiv">
      ...
      <div className="fallOfWickets fallOfWic py-0 mt-3"> {/* add loading class here */}
            ...
            <div className="row keyValueDiv">
              ...
              <div className="col-5 col-sm-8 key value"> <span>Balanced</span></div>
            </div>
            <div className="row keyValueDiv">
              <div className="col-7 col-sm-4 value">AVG 1ST INNING SCORE</div>
              <div className="col-5 col-sm-8 key value"> <span>292</span></div>
            </div>
            <div className="row keyValueDiv">
              <div className="col-7 col-sm-4 value">WIN PREDICTION</div>
              <div className="col-5 col-sm-8 key value"> <span>Mumbai</span></div>
            </div>
      </div>
