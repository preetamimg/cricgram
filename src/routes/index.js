  ...
  return (
    <>
      <Routes>
        ...
        <Route path={`${ROUTE_CONST.LIVE_SCORE}/:id/:matchName`} element={<AppLayout LayoutComponent={LiveScorePage} Content={Commentary} />}/>
        
        <Route path={`${ROUTE_CONST.LIVE_SCORECARD}/:id/:matchName`} element={<AppLayout LayoutComponent={MatchDetailsLayout}/>}/>

        <Route path={`${ROUTE_CONST.MATCH_SQUADS}/:id/:matchName`} element={<AppLayout LayoutComponent={MatchDetailsLayout}/>}/>

        <Route path={ROUTE_CONST.PLAYER_DETAIL} element={<AppLayout LayoutComponent={PlayerDetail}/>}/>
        <Route path={ROUTE_CONST.SERIES_DETAIL} element={<AppLayout LayoutComponent={SeriesDetail}/>}/>
      </Routes>
    </>
  )
};
